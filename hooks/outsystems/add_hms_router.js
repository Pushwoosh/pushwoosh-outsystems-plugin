...
module.exports = function(context) {
    return new Promise(function(resolve, reject) {
        ...
        if (!zipFile) {
            console.warn("[PUSHWOOSH HELPER] HuaweiMessagingRouterService.zip not found — HuaweiMessagingRouterService service will NOT be added to AndroidManifest.xml");
            return resolve();
        }
