...
<p align="center">
  Built from <a href="https://github.com/Pushwoosh/pushwoosh-phonegap-plugin">Pushwoosh Cordova Plugin</a> 8.3.70.
</p>
...
{
  "plugin": {
    "url": "https://github.com/Pushwoosh/pushwoosh-outsystems-plugin.git#8.3.70-OS.7",
    "variables": [
