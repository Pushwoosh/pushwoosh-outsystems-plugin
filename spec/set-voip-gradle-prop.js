...
module.exports = function (ctx) {
  try {
    ...
    // The property only matters when VoIP is enabled, and the build is
    // more valuable than the property.
    console.log('[pushwoosh-cordova-plugin] Could not write PW_VOIP_ANDROID_ENABLED: ' + e.message);
  }
};
